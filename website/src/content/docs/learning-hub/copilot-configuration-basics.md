...
**Vim mode** *(v1.0.84+)*: Modal editing is now available to everyone in the composer. Turn it on with `/vim`, or set `"editorMode": "vim"` in your configuration to make it the default for every session.
