...
- **Client ID Metadata Document (CIMD)** *(v1.0.83+)*: MCP servers can advertise OAuth client metadata via a CIMD instead of requiring manual client registration, simplifying sign-in for servers that support it.
